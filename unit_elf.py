...
# Color Palette
BACKGROUND_COLOR = "rgb(69, 90, 100)"   # Dark Blue-Grey
BUTTON_COLOR = "rgb(96, 125, 139)"      # Muted Blue-Grey
ACCENT_COLOR = "rgb(120, 144, 156)"     # Soft Blue-Grey
TEXT_COLOR = "rgb(224, 224, 224)"       # Light Grey
HOVER_COLOR = "rgb(38, 50, 56)"         # Darker Blue-Grey
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        buttons_info = [
            ("pushButton_tambahkendaraan", "Tambah Kendaraan Elf", self.Tambah),
            ("pushButton_perbaruikendaraan", "Perbarui Kendaraan Elf", self.Edit),
            ("pushButton_hapuskendaraan", "Hapus Kendaraan Elf", self.Hapusl),
            ("pushButton_reset", "Lihat Kendaraan Elf", self.Lihat)
        ]
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Manajemen Kendaraan Elf"))
        self.label.setText(_translate("MainWindow", "KELOLA ELF"))
