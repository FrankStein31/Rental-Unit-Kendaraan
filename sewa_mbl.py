...
# Form implementation generated from reading ui file 'sewa_mobil.ui'
#
...
"color: rgb(255, 255, 255);")
    ...
    def set_motor_id(self, motor_id):
        ...
        print(f"Motor ID diterima: {motor_id}")  # Menampilkan ID yang diterima untuk debugging
    ...
    def simpan_data(self):
        try:
            ...
            if motor_result:
                ...
                harga_sewa = motor_result[1]  #
                driver = motor_result[2]  
                stok = motor_result[3]  

                if stok > 0:
                    # Query untuk menyimpan data ke dalam tabel pinjam
                    query_insert = """
                    INSERT INTO pinjam (id_mobil, harga_sewa_mobil, tanggal_pinjam, tanggal_kembali, driver)
                    VALUES (%s, %s, %s, %s, %s)
                    """
