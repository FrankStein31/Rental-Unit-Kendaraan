...
# Form implementation generated from reading ui file 'motor1.ui'
#
...
"background-color: rgb(255, 202, 111);")
    ...
    def cari_motor(self):
        try:
            ...
            query = "SELECT * FROM motor WHERE id_mtr = %s"  # Use parameterized query to avoid SQL injection
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Data Motor yang Tersedia"))
