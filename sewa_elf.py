...
# Form implementation generated from reading ui file 'sewa_elf.ui'
#
        ...
        try:
            ...
            if motor_result:
                ...
                if stok > 0:
                    ...
                    query_insert = """
                    INSERT INTO pinjam_elf (id_elf, harga_sewa_elf, tanggal_pinjam, tanggal_kembali, driver)
                    VALUES (%s, %s, %s, %s, %s)
                    """
