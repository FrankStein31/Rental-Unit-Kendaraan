...
"background-color: rgb(212, 17, 30);")
    ...
    def search_data(self):
        try:
            ...
            query = """
            SELECT elf.jenis_elf, elf.type_elf, elf.tahun_elf, elf.warna_elf, elf.harga_sewa_elf, pembayaran_elf.status
            FROM elf
            JOIN pembayaran_elf ON elf.id_elf = pembayaran_elf.id_transaksi_elf
            WHERE elf.id_elf = %s
            """
            ...
            if result:
                ...
                cursor.execute("SHOW COLUMNS FROM pembayaran_elf LIKE 'status'")
