...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow, user_id=None):
        ...
        self.label_title.setText("Pembayaran mobil")
    ...
    def load_latest_transaction(self):
        try:
            ...
            query = """
            SELECT p.*, m.harga_sewa_mbl 
            FROM pinjam p
            JOIN mobil m ON p.id_mobil = m.id_mbl
            WHERE p.id_user = %s 
            ...
            if transaction:
                ...
                harga_sewa_per_hari = transaction['harga_sewa_mbl']
                ...
                self.current_transaction_id = transaction['id_transaksi']
            else:
    ...
    def bayar_transaksi(self):
        try:
            ...
            harga_sewa_per_hari = transaksi['harga_sewa_mbl']
            ...
            (id_transaksi, id_user, tanggal_dikembalikan, 
