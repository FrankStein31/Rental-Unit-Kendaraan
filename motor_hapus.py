...
# Form implementation generated from reading ui file 'hapus_motor.ui'
#
...
"background-color: rgb(255, 202, 111);")
    ...
    def delete_motor_data(self):
        # Ambil input ID Motor yang akan dihapus
        id_mtr = self.lineEdit_id.text()
        ...
        try:
            ...
            # Query SQL untuk menghapus data motor
            sql = "DELETE FROM motor WHERE id_mtr = %s"
            val = (id_mtr,)
            mycursor.execute(sql, val)

            # Commit perubahan
            conn.commit()
            print("Data motor berhasil dihapus...")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_simpan.clicked.connect(self.delete_motor_data)
