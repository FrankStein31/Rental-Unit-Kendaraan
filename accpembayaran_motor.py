...
"background-color: rgb(212, 17, 30);")
    ...
    def search_data(self):
        try:
            ...
            query = """
            SELECT motor.jenis_mtr, motor.type_mtr, motor.tahun_mtr, motor.warna_mtr, motor.harga_sewa_mtr, pembayaran_motor.status
            FROM motor
            JOIN pembayaran_motor ON motor.id_mtr = pembayaran_motor.id_transaksi_motor
            WHERE motor.id_mtr = %s
            """
            ...
            if result:
                ...
                cursor.execute("SHOW COLUMNS FROM pembayaran_motor LIKE 'status'")
