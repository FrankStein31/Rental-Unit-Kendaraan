...
# Form implementation generated from reading ui file 'hapus_mobil.ui'
#
...
"background-color: rgb(255, 202, 111);")
    ...
    def cari_mobil(self):
        ...
        try:
            ...
            # Query SQL untuk mencari mobil berdasarkan ID
            ...
            if result:
                ...
                self.lineEdit_jenis.setText(str(result[1]))  # jenis_mbl
                self.lineEdit_type.setText(str(result[2]))  # type_mbl
                self.lineEdit_tahun.setText(str(result[3]))  # tahun_mbl
                self.lineEdit_warna.setText(str(result[4]))  # warna_mbl
                self.lineEdit_stok.setText(str(result[5]))  # stok_mbl
                self.lineEdit_harga.setText(str(result[6]))  # harga_sewa_mbl
            else:
    ...
    def delete_mobil_data(self):
        # Ambil input ID Mobil yang akan dihapus
        id_mbl = self.lineEdit_id.text()
        ...
        try:
            ...
            sql = "DELETE FROM mobil WHERE id_mbl = %s"
            val = (id_mbl,)
            mycursor.execute(sql, val)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_simpan.clicked.connect(self.delete_mobil_data)
