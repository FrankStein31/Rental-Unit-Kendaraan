...
import motor_edit as E
import motor_hapus as H
import motor_tambah as T
import motor_lihat as L

# Color Palette
BACKGROUND_COLOR = "rgb(38, 50, 56)"    # Dark Blue-Grey
BUTTON_COLOR = "rgb(55, 71, 79)"        # Muted Blue-Grey
ACCENT_COLOR = "rgb(96, 125, 139)"      # Soft Blue-Grey
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        buttons_info = [
            ("pushButton_tambahkendaraan", "Tambah Kendaraan Motor", self.Tambah),
            ("pushButton_perbaruikendaraan", "Perbarui Kendaraan Motor", self.Edit),
            ("pushButton_hapuskendaraan", "Hapus Kendaraan Motor", self.Hapusl),
            ("pushButton_reset", "Lihat Kendaraan Motor", self.Lihat)
        ]
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Manajemen Kendaraan Motor"))
        self.label.setText(_translate("MainWindow", "KELOLA MOTOR"))
