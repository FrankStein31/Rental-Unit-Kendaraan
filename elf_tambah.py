...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        # Judul
        title_label = QtWidgets.QLabel("Tambah Data elf")
        ...
        # Form Layout Add
        form_layout.addRow("ID elf:", self.lineEdit_id)
        form_layout.addRow("Jenis elf:", self.lineEdit_jenis)
        form_layout.addRow("Tipe elf:", self.lineEdit_type)
        ...
        self.pushButton_simpan.clicked.connect(self.insert_elf_data)
    ...
    def go_back(self):
        from unit_elf import Ui_MainWindow as T
    ...
    def choose_image(self):
        ...
        file_name, _ = QFileDialog.getOpenFileName(None, "Pilih Foto elf", "", 
    ...
    def insert_elf_data(self):
        ...
        try:
            ...
            # Pesan sukses
            QMessageBox.information(None, "Sukses", "Data elf Berhasil Disimpan!")
