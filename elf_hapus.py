...
"background-color: rgb(255, 202, 111);")
    ...
    def delete_elf_data(self):
        # Ambil input ID Elf yang akan dihapus
        id_elf = self.lineEdit_id.text()
        ...
        try:
            ...
            # Query SQL untuk menghapus data elf
            sql = "DELETE FROM elf WHERE id_elf = %s"
            val = (id_elf,)
            mycursor.execute(sql, val)

            # Commit perubahan
            conn.commit()
            print("Data elf berhasil dihapus...")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_simpan.clicked.connect(self.delete_elf_data)
