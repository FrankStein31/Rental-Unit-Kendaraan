...
# Form implementation generated from reading ui file 'edit_mobil.ui'
#
...
"background-color: rgb(212, 17, 30);")
    ...
    def cari_mobil(self):
        ...
        try:
            ...
            sql = "SELECT * FROM mobil WHERE id_mbl = %s"
            val = (id_mtr,)
            ...
            if result:
                ...
                QtWidgets.QMessageBox.information(self.centralwidget, "Data Tidak Ditemukan", "Mobil dengan ID tersebut tidak ditemukan.")
    ...
    def update_mobil_data(self):
        ...
        id_mbl = self.lineEdit_id.text()  # Ambil input ID Motor
        jenis_mbl = self.lineEdit_jenis.text()  # Ambil input Jenis Motor
        type_mbl = self.lineEdit_type.text()  # Ambil input Tipe Motor
        tahun_mbl = self.lineEdit_tahun.text()
        warna_mbl = self.lineEdit_warna.text()  # Ambil input Warna Motor
        stok_mbl = int(self.lineEdit_stok.text())  # Ambil input Stok Motor
        harga_sewa_mbl = int(self.lineEdit_harga.text())  # Ambil input Harga Sewa
        ...
        try:
            ...
            sql = """
            UPDATE mobil
            SET jenis_mbl = %s, type_mbl = %s, tahun_mbl = %s, warna_mbl = %s, stok_mbl = %s, harga_sewa_mbl = %s
            WHERE id_mbl = %s
            """
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_simpan.setText(_translate("MainWindow", "edit"))
