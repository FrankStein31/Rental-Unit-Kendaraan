...
# Form implementation generated from reading ui file 'tambah_motor.ui'
#
...
"background-color: rgb(255, 202, 111);")
        ...
        self.label_10.setGeometry(QtCore.QRect(360, 20, 91, 21))
        font = QtGui.QFont()
...
"background-color: rgb(212, 17, 30);")
    ...
    def insert_motor_data(self):
        ...
        id_mtr = self.lineEdit_id.text()           # Ambil input dari field ID Motor
        jenis_mtr = self.lineEdit_jenis.text()        # Ambil input dari field Jenis Motor
        type_mtr = self.lineEdit_type.text()         # Ambil input dari field Tipe Motor
        tahun_mtr = self.lineEdit_tahun.text()
        warna_mtr = self.lineEdit_warna.text()        # Ambil input dari field Warna Motor
        stok_mtr = int(self.lineEdit_stok.text())    # Ambil input dari field Stok Motor, pastikan konversi ke int
        ...
        try:
            ...
            sql = """
            INSERT INTO motor (id_mtr,jenis_mtr, type_mtr,tahun_mtr, warna_mtr, stok_mtr,harga_sewa_mtr)
            VALUES (%s, %s, %s, %s, %s,%s,%s)
            """
            val = (id_mtr, jenis_mtr, type_mtr,tahun_mtr, warna_mtr, stok_mtr,harga_sewa_mtr)
