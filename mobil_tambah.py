...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        # Judul
        title_label = QtWidgets.QLabel("Tambah Data mobil")
        ...
        # Form Layout Add
        form_layout.addRow("ID mobil:", self.lineEdit_id)
        form_layout.addRow("Jenis mobil:", self.lineEdit_jenis)
        form_layout.addRow("Tipe mobil:", self.lineEdit_type)
    ...
    def go_back(self):
        from unit_mobil import Ui_MainWindow as T
    ...
    def choose_image(self):
        ...
        file_name, _ = QFileDialog.getOpenFileName(None, "Pilih Foto mobil", "", 
    ...
    def insert_mobil_data(self):
        ...
        try:
            ...
            sql = """
            INSERT INTO mobil 
            (id_mbl, jenis_mbl, type_mbl, tahun_mbl, warna_mbl, stok_mbl, harga_sewa_mbl, driver, foto)
            ...
            # Pesan sukses
            QMessageBox.information(None, "Sukses", "Data mobil Berhasil Disimpan!")
